 ...
 * {@link AvailableFragment.OnFragmentInteractionListener} interface
...
public class AvailableFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new SubjectDisplayAdapter(BranchSubjectActivity.subjectList);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), recyclerView, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                final Subject subject = BranchSubjectActivity.subjectList.get(position);
    ...
    public static void setData() {
        if (BranchSubjectActivity.subjectList.isEmpty()) {
    ...
    private class AllocateSubject extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            data.put("semester_number", BranchSubjectActivity.semester_number);

            return rh.sendPostRequest(Config.ALLOCATE_SUBJECT_BRANCH, data);
        }
    }
