 ...
 * {@link StudentAvailableFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link StudentAvailableFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class StudentAvailableFragment extends Fragment {
    ...
    public StudentAvailableFragment() {
    ...
    public static StudentAvailableFragment newInstance(String param1, String param2) {
        StudentAvailableFragment fragment = new StudentAvailableFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new FacultyDisplayAdapter(StudentClassActivity.studentList);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), recyclerView, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                final Faculty student = StudentClassActivity.studentList.get(position);
                student_code = student.getCode();
                new AlertDialog.Builder(getActivity())
                        .setTitle("Allocate " + student.getTitle() + "!")
                        .setMessage("Do you want to allocate "+student.getTitle()+" to your branch?")
                        .setCancelable(false)
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                new AllocateStudent().execute();
                            }
                        })
    ...
    public static void setData() {
        if (StudentClassActivity.studentList.isEmpty()) {
            text.setText("No Student Available!!");
    ...
    private class AllocateStudent extends AsyncTask<String, Void, String> {

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            loading = ProgressDialog.show(getActivity(), null, "Allocating Student...", true, true);
        ...
        protected String doInBackground(String... params) {
            ...
            return rh.sendPostRequest(Config.ALLOCATE_CLASS_STUDENT, data);
        }
    }
