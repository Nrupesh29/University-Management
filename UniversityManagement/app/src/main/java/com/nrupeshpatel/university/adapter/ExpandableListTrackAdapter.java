...
public class ExpandableListTrackAdapter extends BaseExpandableListAdapter {
    ...
    public ExpandableListTrackAdapter(Context context, List<String> listDataGroup, HashMap<String, List<Unit>> listDataChild) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        childStatus = getChild(mGroupPosition, mChildPosition).getStatus();

        if (convertView == null) {

            LayoutInflater inflater = (LayoutInflater) this.mContext
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.group_child_item_track, null);
            ...
            childViewHolder.mImageView = (ImageView) convertView
                    .findViewById(R.id.status);

            convertView.setTag(R.layout.group_child_item_track, childViewHolder);

        } else {

            childViewHolder = (ChildViewHolder) convertView
                    .getTag(R.layout.group_child_item_track);
        }

        childViewHolder.mChildText.setText(childText);

        if (childStatus.equals("Completed")) {
            childViewHolder.mImageView.setImageResource(R.drawable.ic_light_green);
        } else {
            childViewHolder.mImageView.setImageResource(R.drawable.ic_light_red);
        }
