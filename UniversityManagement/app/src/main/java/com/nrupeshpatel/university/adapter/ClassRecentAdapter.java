...
public class ClassRecentAdapter extends RecyclerView.Adapter<ClassRecentAdapter.MyViewHolder> {
    ...
    public ClassRecentAdapter(List<Class> classList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.class_recent_row, parent, false);
