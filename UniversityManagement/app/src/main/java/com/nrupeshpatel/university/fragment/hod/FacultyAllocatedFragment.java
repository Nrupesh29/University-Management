 ...
 * {@link FacultyAllocatedFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FacultyAllocatedFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FacultyAllocatedFragment extends Fragment {
    ...
    public FacultyAllocatedFragment() {
    ...
    public static FacultyAllocatedFragment newInstance(String param1, String param2) {
        FacultyAllocatedFragment fragment = new FacultyAllocatedFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new SubjectDisplayAdapter(FacultySubjectActivity.subjectAllocatedList);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), recyclerView, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                final Subject subject = FacultySubjectActivity.subjectAllocatedList.get(position);
    ...
    private class RemoveSubject extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            return rh.sendPostRequest(Config.REMOVE_SUBJECT_FACULTY, data);
        }
    }

    public static void setData() {
        if (FacultySubjectActivity.subjectAllocatedList.isEmpty()) {
